...
print("Chosen on TRAIN (2015-2019):  window", best,
      "  Sharpe {:.3f}".format(train_sharpes[best]))
print("Same window on TEST (2020-23): Sharpe {:.3f}".format(strat_sharpe(best, test_mask)))

bench = rets[test_mask]
print("Buy-and-hold on TEST:          Sharpe {:.3f}".format(
