...
paths = simulate_gbm(s0=100, mu=0.10, sigma=0.20, T=1.0, n_steps=252, n_paths=20, seed=42)
...
many = simulate_gbm(s0=100, mu=0.10, sigma=0.20, T=1.0, n_steps=252, n_paths=20000, seed=1)
final_prices = many[:, -1]
